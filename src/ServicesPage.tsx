        ...
        <div className="relative z-10 w-full max-w-[100rem] mx-auto px-8 py-24">
          ...
          >
            ...
            <h1 className="font-heading text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-8xl text-white mt-4 mb-8 leading-none uppercase">
              ...
              <br />
              <span className="text-primary">{t('services', 'heroLine2')}</span>
            </h1>
                      ...
                      <div className={`min-w-0 w-full flex ${isReversed ? 'lg:order-1' : 'lg:order-2'}`}>
                        <div className="w-full border border-dark-grey/10 bg-white p-6 sm:p-8 xl:p-10 flex flex-col justify-center min-w-0">
                          <div className="space-y-6 min-w-0 w-full">
                            ...
                            {/* Read-more to the dedicated corrosion-protection landing page. */}
                            {slug === 'corrosionProtection' && (
                              <Link
                                to={localize('/services/corrosiebescherming')}
                                className="inline-flex items-center gap-2 font-paragraph text-sm font-bold uppercase tracking-wider text-primary hover:gap-3 transition-all w-fit"
                              >
                                {locale === 'NL' ? 'Meer over corrosiebescherming' : 'More about corrosion protection'}
                                <ArrowRight className="w-4 h-4" />
                              </Link>
                            )}
