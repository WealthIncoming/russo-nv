...
export default function HomePage() {
  ...
  return (
    <div ref={containerRef} className="bg-black min-h-screen text-white selection:bg-primary selection:text-white overflow-clip">
      ...
      {/* --- INTRO / STATS --- */}
      <section className="relative w-full max-w-[120rem] mx-auto px-6 md:px-12 pt-24 md:pt-32 xl:pt-40 pb-20 md:pb-24 xl:pb-32 bg-dark-grey overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-20 items-center">
          <div className="relative min-h-[400px] md:min-h-[550px] lg:min-h-[700px] overflow-hidden">
            <div className="absolute inset-0 border border-white/10 z-10 pointer-events-none" />
            <div className="absolute top-0 left-0 w-6 h-6 border-t border-l border-primary z-20" />
            <div className="absolute bottom-0 right-0 w-6 h-6 border-b border-r border-primary z-20" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-10 max-w-3xl">
              {STATS_DATA.map((stat, index) => (
                <div key={index} className="border-l-4 border-primary pl-6 py-2 min-w-0 bg-black/20 hover:bg-black/40 transition-colors duration-300 overflow-hidden">
                  ...
                  <div className="font-paragraph text-white/40 text-sm mt-1 break-words">
                    {stat.sub}
                  </div>
                </div>
              ))}
