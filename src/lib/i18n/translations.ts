...
export const translations: Record<Language, Translations> = {
  EN: {
    ...
    about: {
      ...
      heroLine1: 'Our',
      heroLine2: 'Story',
      heroDescription: 'Three decades of industrial coating excellence across Europe — built on expertise, safety, and uncompromising quality.',
      storyTitleLine1: 'Built On',
      storyTitleLine2: 'Experience',
      storyParagraph1: 'Founded over 30 years ago, Russo NV has grown from a small Belgian coating contractor into one of the most trusted names in industrial surface protection across Europe.',
      storyParagraph2: 'Our team of certified professionals delivers high-performance coating solutions for the most demanding industrial environments — from storage terminals and petrochemical plants to food production facilities and maritime infrastructure.',
      storyParagraph3: 'With projects spanning Belgium, the Netherlands, France, Germany, and Luxembourg, we bring local expertise and international standards to every job.',
      storyYearsExperience: 'Years of Experience',
      storyCountriesServed: 'Countries Served',
      missionTitle: 'Our',
      ...
      valueExpertTeamDesc: 'Certified professionals with decades of hands-on experience in industrial coating applications across diverse sectors.',
      ...
      expertiseDescription: 'Specialized industrial coating services backed by decades of field experience and industry-leading certifications.',
      ...
      ctaTitleHighlight: 'Next Project?',
      ctaDescription: 'Let us bring three decades of expertise and quality to your industrial coating needs.',
      ctaButton: 'Request Quote',
  ...
  NL: {
    ...
    about: {
      ...
      heroLine1: 'Ons',
      heroLine2: 'Verhaal',
      heroDescription: 'Drie decennia industriële coating-excellentie in heel Europa — gebouwd op expertise, veiligheid en compromisloze kwaliteit.',
      storyTitleLine1: 'Gebouwd Op',
      storyTitleLine2: 'Ervaring',
      storyParagraph1: 'Meer dan 30 jaar geleden opgericht, is Russo NV uitgegroeid van een kleine Belgische coatingaannemer tot een van de meest vertrouwde namen in industriële oppervlaktebescherming in Europa.',
      storyParagraph2: 'Ons team van gecertificeerde professionals levert hoogwaardige coatingoplossingen voor de meest veeleisende industriële omgevingen — van opslagterminals en petrochemische installaties tot voedselproductiefaciliteiten en maritieme infrastructuur.',
      storyParagraph3: 'Met projecten in België, Nederland, Frankrijk, Duitsland en Luxemburg brengen wij lokale expertise en internationale normen naar elke opdracht.',
      storyYearsExperience: 'Jaren Ervaring',
      storyCountriesServed: 'Landen Bediend',
      missionTitle: 'Onze',
      ...
      valueExpertTeamDesc: 'Gecertificeerde professionals met tientallen jaren praktijkervaring in industriële coatingtoepassingen in diverse sectoren.',
      ...
      expertiseTitle: 'Onze',
      expertiseHighlight: 'Expertise',
      expertiseDescription: 'Gespecialiseerde industriële coatingdiensten ondersteund door tientallen jaren veldervaring en toonaangevende certificeringen.',
      ...
      ctaDescription: 'Laat ons drie decennia expertise en kwaliteit inzetten voor uw industriële coatingbehoeften.',
      ctaButton: 'Offerte Aanvragen',
