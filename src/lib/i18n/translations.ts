...
export const translations: Record<Language, Translations> = {
  EN: {
    ...
    industries: {
      ...
      gridTitleLine1: 'Specialized Solutions',
      gridTitleHighlight: 'For Each Environment',
    ...
    projects: {
      ...
      gridDescription: 'A selection of large-scale coating, blasting, and protection projects delivered for industrial clients across Europe — each with its own surface, schedule, and constraints.',
    ...
    contact: {
      ...
      toastDescription: 'Your email client should have opened with a prefilled message. Please send it from there to complete your inquiry — or reach us directly at info@russonv.be.',
  ...
  NL: {
    ...
    industries: {
      ...
      gridTitleLine1: 'Gespecialiseerde Oplossingen',
      gridTitleHighlight: 'Voor Elke Omgeving',
    ...
    projects: {
      ...
      gridDescription: 'Een selectie van grootschalige coating-, straal- en beschermingsprojecten die we hebben uitgevoerd voor industriële klanten in heel Europa — elk met zijn eigen oppervlak, planning en uitdagingen.',
    ...
    contact: {
      ...
      sending: 'Verzenden...',
      toastTitle: 'E-mailclient Geopend',
      toastDescription: 'Uw e-mailclient zou nu geopend moeten zijn met een vooraf ingevuld bericht. Verstuur het van daaruit om uw aanvraag te voltooien — of neem direct contact op via info@russonv.be.',
